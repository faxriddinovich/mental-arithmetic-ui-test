...
export default defineComponent({
  ...
  setup(props) {
    ...
    async function getCourses(search = false) {
      ...
      console.log("courses get method: ", RPC_GET_COURSES_METHOD)

      try {
        const response = await rpc.request(RPC_GET_COURSES_METHOD, params)
        if (search)
